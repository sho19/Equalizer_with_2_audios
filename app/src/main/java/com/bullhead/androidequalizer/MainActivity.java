...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer2 = MediaPlayer.create(this, R.raw.faded);
        final int sessionId = mediaPlayer.getAudioSessionId();
        final int sessionId2 = mediaPlayer2.getAudioSessionId();
        ...
        EqualizerFragment trackFragment = EqualizerFragment.newBuilder()
                .setAccentColor(Color.parseColor("#4caf50"))
                .setAudioSessionId(sessionId2)
                .build();
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.trackFrame, trackFragment)
                .commit();
    }
